  ...
  >
    ...
    >
      <h3 className='text-white fw-bold px-9 mt-10 mb-6'>
        Projects <span className='fs-8 opacity-75 ps-3'>12 Active</span>
      </h3>
      ...
      <div className='tab-pane fade show active' id='kt_topbar_notifications_2' role='tabpanel'>
        <div className='d-flex flex-column px-9'>
          <div className='pt-10 pb-0'>
            <h3 className='text-dark text-center fw-bolder'>Put projects repo here as well!</h3>

            <div className='text-center text-gray-600 fw-bold pt-1 mb-100'>
              And add links just like in the 'overview' page
            </div>
