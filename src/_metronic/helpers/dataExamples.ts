...
const defaultMessages: Array<MessageModel> = [
  {
    user: 4,
    type: 'in',
    text: 'Hi! I saw that you set up our meeting for this Friday. Excited to connect! Let me know if you have any questions in the meantime.',
    time: '2 hours',
  },
  {
    user: 2,
    type: 'out',
    text: 'Hi Mona. Great to connect. Our team does have a few ESG questions actually.',
    time: '1 hour',
  },
  {
    user: 4,
    type: 'in',
    text: 'Sounds great. Feel free to ask them here and I will prepare some materials for our call.',
    time: '45 minutes',
  },
  {
    user: 2,
    type: 'out',
    text: 'Wonderful--I will get them to you later today!',
    time: '15 minutesd',
  },
]
